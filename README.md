...
Время работы оценивалось на n = 15000, если взять больше, то наивная реализация получала 
OutOfMemoryError: Java heap space. Время в миллисекундах.

|            Операция           	| Наивная реализация 	        | Персистентный список       	|
|:-----------------------------:    |:-------------------------:	|:---------------------------:	|
| Добавление по индексу          	|            2922           	|             1105            	|
| Изменение по индексу          	|            22978           	|             1032            	|
| Удаление по индексу           	|            454               	|             1129            	|
| Добавление в начало            	|            21663           	|             1054            	|
| Добавление в конец            	|            8407           	|             2             	|
| Изменение в начале              	|            48251           	|             1             	|
| Изменение в конеце             	|            422               	|             4             	|
| Удаление в начале                	|            311               	|             4             	|
| Удаление в конеце                	|            248               	|             3                	|
