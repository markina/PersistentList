...
OutOfMemoryError: Java heap space. Для операций удалениея и изменения сначала было 
добавлено n элеметов, затем производился замер времени. 
...
| Изменение в конеце             	|            579              	|             1             	|
| Удаление в начале                	|            290              	|             1             	|
| Удаление в конеце                	|            289              	|             1                	|
